...
# add People of Note and Studies of Note to the list
...
def generate_question_tags(excerpt):
    ...
    user_prompt = f"""
        ...
        2. Generate a list of tags as a subset of a provided list of available tags that represent any portion content in the excerpt - be reasonably thorough here.
    ...
    If a portion of the excerpt touches on a topic represented in TAGS_LIST, it must be included in the list.
